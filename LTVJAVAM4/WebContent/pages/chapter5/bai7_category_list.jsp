...
<a href="${pageContext.request.contextPath}/chapter5/bai7-category/add.html" class="btn btnprimary">Add</a>
<form method="post" action="${pageContext.request.contextPath}/admin/author/dels.html"> <!-- Sua sau -->
  <table class="table">
    <tr>
